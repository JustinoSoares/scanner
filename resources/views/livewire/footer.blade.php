<div>
    {{-- Footer. --}}
    <footer class="bg-slate-200 pb-8">
        <div class="NewSletter py-8 flex flex-col md:flex-row lg:flex-row justify-center md:justify-around lg:justify-around items-center">
            ...
            <div class="w-[20rem]">
                <input class="w-full  p-2 rounded-lg outline-none placeholder:text-slate-600 " type="email" placeholder="justinocsoares123@gmail.com">
                <textarea class="border rounded-lg p-2 my-1 placeholder:text-slate-600  border-slate-300 outline-none w-full "
                    placeholder="Dê a sua sugestão de melhoria, aqui!!" id="" cols="20" rows="2"></textarea>
                <button class="float-end text-white rounded-sm font-bold"
                    type="submit"><img class="w-7 h-7" src="{{ asset("build/assets/svg/send.svg") }}" alt=""></button>
            </div>
        </div>

        <div class="flex pb-4 flex-col md:flex-row lg:flex-row justify-center md:justify-around lg:justify-around  border-t-[2px] border-t-[#774444] pt-4 ">
            {{-- Resumo do site --}}
